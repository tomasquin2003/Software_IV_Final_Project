...
import VotacionSystem.ControllerEstacionPrx;
import VotacionSystem.ControllerEstacionDisp;
 ...
 * @author JRuiz1601
 */
public class ControllerEstacionImpl extends ControllerEstacionDisp {
    ...
    public boolean autenticarVotante(String cedula, Current current) throws VotanteNoAutorizadoException {
        ...
        try {
            ...
            if (autorizado) {
                ...
                throw new VotanteNoAutorizadoException("Votante no autorizado en esta mesa", cedula);
            }
            ...
            throw new VotanteNoAutorizadoException("Error en el proceso de autenticación", cedula);
        }
    }
}