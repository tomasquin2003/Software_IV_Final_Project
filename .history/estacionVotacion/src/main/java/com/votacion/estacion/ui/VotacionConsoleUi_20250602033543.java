 ...
 * @author JRuiz1601
 */
public class VotacionConsoleUI {    private final Scanner scanner;
    private final ControllerEstacionImpl controllerEstacion;
     ...
     */    public VotacionConsoleUI(ControllerEstacionImpl controllerEstacion, 
