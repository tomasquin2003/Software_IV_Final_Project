...
import VotacionSystem.SistemaMonitorizacionDisp;
 ...
 * @author JRuiz1601
 */
public class SistemaMonitorizacionImpl extends SistemaMonitorizacionDisp {
    ...
    public boolean iniciarVerificacion(String cedula, Current current) throws VotanteNoAutorizadoException {
        ...
        try {
            ...
            throw new VotanteNoAutorizadoException("Error en el proceso de verificación", cedula);
        }
    }
}