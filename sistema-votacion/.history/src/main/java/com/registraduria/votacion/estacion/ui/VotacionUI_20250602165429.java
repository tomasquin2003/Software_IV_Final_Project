...
public class VotacionUI {
    ...
    private String solicitarCedula() {
        System.out.println("Ingrese el número de cédula del votante (o 'salir' para terminar):");
        String cedula = scanner.nextLine().trim();
        
        // Validar formato de cédula (simplificado para el ejemplo)
        while (!cedula.equalsIgnoreCase("salir") && !cedula.matches("\\d+")) {
            System.out.println("Formato de cédula inválido. Por favor, ingrese solo números:");
    ...
    private boolean autenticarVotante(String cedula) {
        ...
        try {
            ...
            if (resultado) {
                System.out.println("¡Autenticación exitosa! El votante puede proceder a votar.");
                return true;
            } else {
                System.out.println("Autenticación fallida. El votante no está autorizado.");
                return false;
            }
    ...
    private String solicitarVoto() {
        ...
        System.out.println("\nIngrese el número del candidato de su elección (o 'cancelar'):");
